package com.xhhao.comment.widget.network;
...
/**
 * Validates plugin-controlled outbound HTTP requests and blocks private network targets.
 */
@Component
public class CommentNextOutboundUriPolicy {

    public URI normalize(URI candidate) {
    ...
    public Mono<URI> validate(URI candidate) {
